        ...
        div style = {
            {
                ...
                alignItems: "center",
                background: "radial-gradient(circle at top left,#ff8de1 0%,#2b123c 40%,#0f0f0f 100%)",
                fontFamily: "Arial",
                padding: "20px",
                position: "relative",
                overflow: "hidden",
        ...
        style = {
            {
                ...
                border: "none",
                borderRadius: "15px",
                background: "linear-gradient(90deg,#c77dff,#ff8de1)",
                color: "white",
                fontSize: "18px",
                fontWeight: "bold",
                cursor: "pointer",
                transition: "0.3s",
                boxShadow: "0 0 20px rgba(199,1825,255,0.8)",
                letterSpacing: "1px",
            }
        }
        onMouseOver = {
