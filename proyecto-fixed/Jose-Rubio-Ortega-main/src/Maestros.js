...
/* Primaria: un maestro titular por grupo da todas las materias */
...
const EMPTY_FORM = { nombre:"", email:"", tel:"", grupo:"" };
                      ...
                      <tr key={m.id}>
                        ...
                        <td>
                          <button className="btn btn-sm btn-primary"
                            onClick={()=>{setMaestroEdit(m);setModalForm(true);}}>✏️ Editar</button>
                        </td>
                      </tr>
                    );
                  })}
