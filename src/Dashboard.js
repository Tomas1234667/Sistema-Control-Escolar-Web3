...
function Dashboard() {
    ...
    return ( <
        Layout title = "Dashboard" > { /* STAT CARDS */ } <
        ...
        <
        div className = "card-title" > Asistencia por Grupo < /div> <
        /div> {
            chartData.length > 0 ? ( <
                ...
                div className = "empty-title" > Sin datos de asistencia hoy < /div> <
        ...
        /div> {
            pieData.length > 0 ? ( <
                ...
                div className = "empty-state" > < div className = "empty-icon" > ✨ < /div><div className="empty-title">Sin datos suficientes</div > < /div>
            )
        } <
        /div> <
        /div>
