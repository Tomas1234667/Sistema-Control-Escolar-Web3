      ...
      <div className="modal modal-lg">
        ...
        <div className="grid-2">
          ...
          <div>
            <div className="exp-section">
              ...
              <div className="exp-row">
                ...
                <span>{alumno.fechaNac}</span>
              </div>

              <div className="exp-row">
                <span>CURP</span>
                <span style={{ fontSize: 11 }}>{alumno.curp || "—"}</span>
              </div>
              ...
              <div className="exp-row">
                ...
                <span>{alumno.sangre}</span>
              </div>

              <div className="exp-row">
                <span>Alergias</span>
                <span>{alumno.alergias}</span>
              </div>
            </div>
            ...
            <div className="qr-box">
              ...
              <div style={{ fontWeight: 700, fontSize: 13 }}>
                ALU - {alumno.id.slice(0, 8).toUpperCase()}
              </div>
              <div className="small muted" style={{ marginTop: 4 }}>
                Código QR para pase de lista rápido
              </div>
            </div>
          </div>
          ...
          <div>
            <div className="exp-section">
              ...
              <div className="exp-row">
                ...
                <strong
                  style={{
                    color:
                      prom >= 8.5 ? "#16a34a" : prom >= 7 ? "#d97706" : "#dc2626",
                  }}
                >
            ...
            <div className="exp-section">
              ...
              {califs.length === 0 ? (
                ...
                califs.map((c) => {
                  ...
                  const color =
                    avgNum >= 8.5 ? "#16a34a" : avgNum >= 7 ? "#d97706" : "#dc2626";
            ...
            <div className="exp-section">
              ...
              <div className="small muted">
                Calculado automáticamente: faltas + promedio + asistencia
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="form-actions">
          ...
          <button
            ...
            onClick={() => toast.success("Boleta PDF lista para imprimir")}
          >
            📄Descargar Boleta
          </button>
        </div>
      ...
      <div className="modal modal-lg">
        <div className="modal-header">
          <div className="modal-title">
            {alumno ? "✏️ Editar Alumno" : "👨‍🎓 Nuevo Alumno"}
          </div>
          <button className="btn btn-ghost btn-icon" onClick={onClose}>
            ✕
          </button>
