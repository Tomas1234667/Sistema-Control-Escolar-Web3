...
function Sidebar({ collapsed, setCollapsed }) {
    return ( <
        ...
        <
        div className = "nav-section" > {!collapsed && "MENÚ PRINCIPAL" } < /div> {
            ...
            div className = "sidebar-footer" >
                ...
                div className = "user-avatar" > MA < /div> {
                    !collapsed && ( <
                        div >
                        <
                        div className = "user-name" > Ma.Antonia García < /div> <
    ...
    function Layout({ children, title }) {
        return ( <
            ...
            <
            span className = "topbar-date" > { new Date().toLocaleDateString("es-MX", { weekday: "long", year: "numeric", month: "long", day: "numeric" }) } <
            /span> <
            /div> <
            /header> <
